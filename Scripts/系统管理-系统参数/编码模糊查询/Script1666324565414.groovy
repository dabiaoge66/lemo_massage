...
String search_name = GlobalVariable.parameter_vague_code

List compare_names = [[By.cssSelector(GlobalVariable.parameter_code_ele)],'模糊查询',
	By.className(GlobalVariable.empty_tips), [true]]  //  [index=3]-字段是否在列表存在(boolean),空值和逆向不用传]

WebUI.sendKeys(findTestObject('系统管理/系统参数/编码搜索框'), search_name)
