...
String search_name = GlobalVariable.parameter_status

List compare_names = [[By.cssSelector(GlobalVariable.parameter_is_enable_ele)], '其他查询',
	 By.className(GlobalVariable.empty_tips), [true]]  //  [index=3]-字段是否在列表存在(boolean),空值和逆向不用传]

WebUI.switchToFrame(findTestObject('frames/主页面/系统管理-系统参数'), 30)

List<WebElement> result = driver.findElements(By.cssSelector(GlobalVariable.parameter_is_enable))
...
WebUI.click(findTestObject('系统管理/系统参数/快速查询按钮'))
...
void setUp() {
	...
	WebUI.click(findTestObject('系统管理/导航栏/系统参数'))
}
