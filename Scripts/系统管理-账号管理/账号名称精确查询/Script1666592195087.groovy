...
String search_name = GlobalVariable.account_exact_name

List compare_names = [[By.cssSelector(GlobalVariable.account_name_ele)],'精确查询',
	By.className(GlobalVariable.empty_tips), [true]]  //  [index=3]-字段是否在列表存在(boolean),空值和逆向不用传]

WebUI.sendKeys(findTestObject('系统管理/账号管理/账号名称搜索框'), search_name)
