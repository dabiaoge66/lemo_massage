...
String search_name = GlobalVariable.service_order_channel

List compare_names = [[By.cssSelector(GlobalVariable.service_order_channel_ele)], '其他查询',
	 By.className(GlobalVariable.empty_tips), [true]]  //  [index=3]-字段是否在列表存在(boolean),空值和逆向不用传]

WebUI.click(findTestObject('订单中心/服务订单/订单渠道搜索框'))
