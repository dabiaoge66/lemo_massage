...
String search_name = GlobalVariable.service_pay_type

List compare_names = [[By.cssSelector(GlobalVariable.service_pay_type_ele)], '其他查询',
	 By.className(GlobalVariable.empty_tips), [true]]  //  [index=3]-字段是否在列表存在(boolean),空值和逆向不用传]

WebUI.click(findTestObject('订单中心/服务订单/支付方式搜索框'))
