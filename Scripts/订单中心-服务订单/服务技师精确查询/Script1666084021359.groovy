...
String search_name = GlobalVariable.exact_service_technical

List compare_names = [[By.cssSelector(GlobalVariable.service_technical_ele)],'精确查询',
	By.className(GlobalVariable.empty_tips), [true]]  //  [index=3]-字段是否在列表存在(boolean),空值和逆向不用传]

WebUI.sendKeys(findTestObject('订单中心/服务订单/服务技师搜索框'), search_name)
