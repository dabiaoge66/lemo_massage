...
WebUI.sendKeys(findTestObject('商户管理/门店管理/门店名称搜索框'), search_name)
...
List tips = [[By.className(GlobalVariable.empty_tips)], '逆向查询',
	By.className(GlobalVariable.empty_tips)]  //  [index=3]-字段是否在列表存在(boolean),空值和逆向不用传]

CustomKeywords.'my.test.kits.TestUtilities.compare_result'(total, next, page_size, search_name, tips) // 断言查询结果
