...
stores = driver.findElements(By.cssSelector(GlobalVariable.merchant_names_ele))

for (int i = 0; i < stores.size(); i++) {
    if (stores[i].text.equals('UItestData_storeName')) {
        System.out.println(stores[i].text)
...
WebUI.click(findTestObject('商户管理/门店管理/编辑按钮'))
