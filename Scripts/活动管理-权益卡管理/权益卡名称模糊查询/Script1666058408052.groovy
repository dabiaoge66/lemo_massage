...
String search_name = GlobalVariable.vague_card_name

List compare_names = [[By.cssSelector(GlobalVariable.card_names_ele)],'模糊查询',
	By.className(GlobalVariable.empty_tips), [true]]  //  [index=3]-字段是否在列表存在(boolean),空值和逆向不用传]

WebUI.sendKeys(findTestObject('活动管理/权益卡管理/权益卡名称搜索框'), search_name)
