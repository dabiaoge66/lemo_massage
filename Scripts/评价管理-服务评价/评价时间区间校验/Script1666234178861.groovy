...
String search_data = GlobalVariable.evaluation_time_start + '/' + GlobalVariable.evaluation_time_end
...
WebUI.sendKeys(findTestObject('评价管理/服务评价/评价时间-开始'), search_name[0])

WebUI.sendKeys(findTestObject('评价管理/服务评价/评价时间-结束'), search_name[1])
