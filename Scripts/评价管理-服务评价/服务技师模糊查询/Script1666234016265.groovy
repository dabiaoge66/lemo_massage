...
String search_name = GlobalVariable.evaluation_vague_technical

List compare_names = [[By.cssSelector(GlobalVariable.evaluation_technical_ele)],'模糊查询',
	By.className(GlobalVariable.empty_tips), [true]]  //  [index=3]-字段是否在列表存在(boolean),空值和逆向不用传]

WebUI.sendKeys(findTestObject('评价管理/服务评价/服务技师搜索框'), search_name)
