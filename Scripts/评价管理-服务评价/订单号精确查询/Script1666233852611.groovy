...
String search_name = GlobalVariable.evaluation_exact_guid

List compare_names = [[By.cssSelector(GlobalVariable.evaluation_guid_ele)],'精确查询',
	By.className(GlobalVariable.empty_tips), [true]]  //  [index=3]-字段是否在列表存在(boolean),空值和逆向不用传]

WebUI.sendKeys(findTestObject('评价管理/服务评价/订单号搜索框'), search_name)
