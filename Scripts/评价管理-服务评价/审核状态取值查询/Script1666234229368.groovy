...
String search_name = GlobalVariable.evaluation_examine_status

List compare_names = [[By.cssSelector(GlobalVariable.evaluation_status_ele)], '其他查询',
	 By.className(GlobalVariable.empty_tips), [true]]  //  [index=3]-字段是否在列表存在(boolean),空值和逆向不用传]

WebUI.click(findTestObject('评价管理/服务评价/审核状态搜索框'))

List<WebElement> result = driver.findElements(By.cssSelector(GlobalVariable.evaluation_examine_status_value))
