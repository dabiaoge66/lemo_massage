...
String search_name = GlobalVariable.rights_vague_orderNo

List compare_names = [[By.cssSelector(GlobalVariable.rights_guid_ele)],'模糊查询',
	By.className(GlobalVariable.empty_tips), [true]]  //  [index=3]-字段是否在列表存在(boolean),空值和逆向不用传]

WebUI.sendKeys(findTestObject('订单中心/权益卡订单/权益卡订单号搜索框'), search_name)
