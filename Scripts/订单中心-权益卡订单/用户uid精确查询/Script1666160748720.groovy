...
String search_name = GlobalVariable.rights_exact_uid

List compare_names = [[By.cssSelector(GlobalVariable.rights_uid_ele)],'精确查询',
	By.className(GlobalVariable.empty_tips), [true]]  //  [index=3]-字段是否在列表存在(boolean),空值和逆向不用传]

WebUI.sendKeys(findTestObject('订单中心/权益卡订单/用户UID搜索框'), search_name)
