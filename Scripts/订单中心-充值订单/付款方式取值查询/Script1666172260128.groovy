...
String search_name = GlobalVariable.recharge_pay_type

List compare_names = [[By.cssSelector(GlobalVariable.recharge_channel_ele)], '其他查询',
	 By.className(GlobalVariable.empty_tips), [true]]  //  [index=3]-字段是否在列表存在(boolean),空值和逆向不用传]

WebUI.click(findTestObject('订单中心/充值订单/付款方式搜索框'))
