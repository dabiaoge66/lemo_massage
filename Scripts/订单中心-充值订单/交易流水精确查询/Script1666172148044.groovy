...
String search_name = GlobalVariable.recharge_exact_serial

List compare_names = [[By.cssSelector(GlobalVariable.recharge_serial_ele)],'精确查询',
	By.className(GlobalVariable.empty_tips), [true]]  //  [index=3]-字段是否在列表存在(boolean),空值和逆向不用传]

WebUI.sendKeys(findTestObject('订单中心/充值订单/交易流水搜索框'), search_name)
