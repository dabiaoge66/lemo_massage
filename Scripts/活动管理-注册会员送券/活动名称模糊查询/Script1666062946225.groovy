...
String search_name = GlobalVariable.vague_delivery_name

List compare_names = [[By.cssSelector(GlobalVariable.delivery_names_ele)],'模糊查询',
	By.className(GlobalVariable.empty_tips), [true]]  //  [index=3]-字段是否在列表存在(boolean),空值和逆向不用传]

WebUI.sendKeys(findTestObject('活动管理/注册会员送券/活动名称搜索框'), search_name)
