...
String search_name = GlobalVariable.banner_exact_name

List compare_names = [[By.cssSelector(GlobalVariable.banner_name_ele)],'精确查询',
	By.className(GlobalVariable.empty_tips), [true]]  //  [index=3]-字段是否在列表存在(boolean),空值和逆向不用传]

WebUI.sendKeys(findTestObject('系统管理/banner图管理/名称搜索框'), search_name)
