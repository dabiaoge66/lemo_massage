...
String search_data = GlobalVariable.create_free_start + '/' + GlobalVariable.create_free_end
...
WebUI.sendKeys(findTestObject('活动管理/闲时优惠/创建时间-开始'), search_name[0])

WebUI.sendKeys(findTestObject('活动管理/闲时优惠/创建时间-结束'), search_name[1])
