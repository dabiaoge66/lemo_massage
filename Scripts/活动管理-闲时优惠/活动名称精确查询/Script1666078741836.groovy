...
String search_name = GlobalVariable.exact_free_name

List compare_names = [[By.cssSelector(GlobalVariable.free_names_ele)],'精确查询',
	By.className(GlobalVariable.empty_tips), [true]]  //  [index=3]-字段是否在列表存在(boolean),空值和逆向不用传]

WebUI.sendKeys(findTestObject('活动管理/闲时优惠/活动名称搜索框'), search_name)
