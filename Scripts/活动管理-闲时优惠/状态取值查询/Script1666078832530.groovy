...
String search_name = GlobalVariable.free_discount_status
...
WebUI.click(findTestObject('活动管理/闲时优惠/状态搜索框'))

List<WebElement> result = driver.findElements(By.cssSelector(GlobalVariable.free_status_value))
