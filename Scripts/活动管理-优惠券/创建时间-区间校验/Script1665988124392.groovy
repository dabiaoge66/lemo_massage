...
List compare_names = [[By.cssSelector(GlobalVariable.coupon_created_time)], '日期比较',
	 By.className(GlobalVariable.empty_tips), [true]]  //  [index=3]-字段是否在列表存在(boolean)

WebUI.sendKeys(findTestObject('活动管理/优惠券/创建时间-开始'), search_name[0])

WebUI.sendKeys(findTestObject('活动管理/优惠券/创建时间-结束'), search_name[1])
