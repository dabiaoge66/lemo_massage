...
String search_name = GlobalVariable.coupon_type

List compare_names = [[By.cssSelector(GlobalVariable.coupon_type_ele)], '其他查询',
	 By.className(GlobalVariable.empty_tips), [true]]  //  [index=3]-字段是否在列表存在(boolean),空值和逆向不用传]

WebUI.click(findTestObject('活动管理/优惠券/优惠券类型搜索框'))
