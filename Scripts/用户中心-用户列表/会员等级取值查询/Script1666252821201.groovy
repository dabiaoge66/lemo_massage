...
String search_name = GlobalVariable.accounts_member_level

List compare_names = [[By.cssSelector(GlobalVariable.accounts_member_level_ele)], '其他查询',
	 By.className(GlobalVariable.empty_tips), [true]]  //  [index=3]-字段是否在列表存在(boolean),空值和逆向不用传]

WebUI.click(findTestObject('用户中心/用户列表/会员等级搜索框'))
