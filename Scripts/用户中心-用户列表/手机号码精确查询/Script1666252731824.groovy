...
String search_name = GlobalVariable.accounts_exact_phone

List compare_names = [[By.cssSelector(GlobalVariable.accounts_phone_ele)],'精确查询',
	By.className(GlobalVariable.empty_tips), [true]]  //  [index=3]-字段是否在列表存在(boolean),空值和逆向不用传]

WebUI.sendKeys(findTestObject('用户中心/用户列表/手机号码搜索框'), search_name)
