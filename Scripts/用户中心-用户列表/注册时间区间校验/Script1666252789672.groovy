...
String search_data = GlobalVariable.accounts_register_start + '/' + GlobalVariable.accounts_register_end
...
WebUI.sendKeys(findTestObject('用户中心/用户列表/注册时间-开始'), search_name[0])

WebUI.sendKeys(findTestObject('用户中心/用户列表/注册时间-结束'), search_name[1])
