...
String search_name = GlobalVariable.vague_entry_data

List compare_names = [[By.cssSelector(GlobalVariable.entry_names_ele)],'模糊查询',
	By.className(GlobalVariable.empty_tips), [true]]  //  [index=3]-字段是否在列表存在(boolean),空值和逆向不用传]

WebUI.sendKeys(findTestObject('产商品管理/休假管理/录入人搜索框'), search_name)
