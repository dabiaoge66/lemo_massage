...
String search_name = GlobalVariable.exact_tech_name
...
WebUI.click(findTestObject('产商品管理/休假管理/技师姓名搜索框'))

List<WebElement> result = driver.findElements(By.cssSelector(GlobalVariable.sid_box_data))
